...
class OthersActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        findViewById<ImageButton>(R.id.on_market_grammarscope_corenlp)?.setOnClickListener { onMarketGrammarScopeCoreNlp() }
        findViewById<ImageButton>(R.id.on_market_grammarscope_corenlp_premium)?.setOnClickListener { onMarketGrammarScopeCoreNlpPremium() }
    ...
    private fun onMarketGrammarScopeCoreNlp() {
        install(R.string.grammarscope_corenlp_uri)
    }

    private fun onMarketGrammarScopeCoreNlpPremium() {
        install(R.string.grammarscope_corenlp_premium_uri)
    }
