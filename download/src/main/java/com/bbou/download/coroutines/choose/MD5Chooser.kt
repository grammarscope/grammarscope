...
object MD5Chooser {
    ...
    fun md5(activity: FragmentActivity) {
        ...
        val nameValues = StorageReports.mergeNamesValues(nameValues1, nameValues2)
     ...
     */
    private fun md5(activity: FragmentActivity, directories: Pair<Array<out CharSequence>, Array<String>>) {
