...
import com.bbou.download.coroutines.utils.FileDataDownloader
...
object UpdateStarter {
    ...
    fun start(activity: FragmentActivity, downloadIntent: Intent) {
        ...
        if (downloadSourceUrl.isEmpty() || name == null) {
        ...
        activity.lifecycleScope.launch {
            val task = FileDataDownloader()
            val srcData = task.run(Dispatchers.IO, downloadSourceUrl)
