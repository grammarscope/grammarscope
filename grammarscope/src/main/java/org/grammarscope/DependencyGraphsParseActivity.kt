...
import org.grammarscope.graph.DependencyGraphsParse
import org.grammarscope.graph.DependencySettings
import org.grammarscope.graph.SentenceGraph

class DependencyGraphsParseActivity : GraphsParseActivity<Token, Token>() {
    ...
    override fun makeParse(): BaseParse<out List<SentenceGraph<Token, Token>>?> {
        return DependencyGraphsParse(this, reverse = settings?.reverseDirection == true)
    }
