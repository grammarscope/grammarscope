...
import org.grammarscope.graph.SemanticGraphsParse
...
class SemanticGraphsParseActivity : GraphsParseActivity<Token, Relation>() {
    ...
    override fun makeParse(): BaseParse<out List<SentenceGraph<Token, Relation>>?> {
        return SemanticGraphsParse(this, reverse = settings?.reverseDirection == true)
    }
