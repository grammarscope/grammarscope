...
android {
    ...
    namespace = "org.grammarscope"

    defaultConfig {
        applicationId = "org.grammarscope"
...
dependencies {
    ...
    runtimeOnly(project(":syntaxnet2_jni"))
    runtimeOnly(project(":syntaxnet_engine"))
